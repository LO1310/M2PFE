...
#define DEFAULT_SCREEN_TIMEOUT  (uint32_t)(-1) // Désactive complètement le timeout
...
void loop()
{
    lv_task_handler();  // Met à jour l'interface LVGL
    delay(5);           // Ajustez le délai si nécessaire
    bool  rlst;
    uint8_t data;
